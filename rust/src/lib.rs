...
pub fn solve(year: u16, day: u8, part: u8, file: &str) {
    ...
    match (year, day, part) {
        ...
        (2023, 14, 1) => println!("Part 1: {}", year2023::day14::solve_part1(&input)),
        (2023, 14, 2) => println!("Part 2: {}", year2023::day14::solve_part2(&input)),
        ...
        (2023, 18, 2) => println!("Part 2: {}", year2023::day18::solve_part2(&input)),

        (2023, 21, 1) => println!("Part 1: {}", year2023::day21::solve_part1(&input)),
